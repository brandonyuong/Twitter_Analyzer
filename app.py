...
postgres_user = input("Host = localhost. Enter the Postgres user: ")
user_password = input("Enter the password: ")
database_name = input("Enter the Postgres database name: ")

Database.initialise(user=postgres_user, password=user_password, host='localhost', database=database_name)
